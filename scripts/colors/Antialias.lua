...
local anycolor = true; -- set true to antialises the edge of the foreground colour no matterwhat colour is bordering it
local extraSmooth = true; --set true to run an extra process over the outside of the forground colour, usually only makes a minor addition and is quite SLOW  
